...
async def shortner_panel(client, query_or_message):
    ...
    if shortner_enabled:
        try:
            test_response = requests.get(f"https://{short_url}/api?api={short_api}&url=https://t.me/Kannada_Filmy_Club&alias=test", timeout=5)
...
<blockquote>**≡ ᴜꜱᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ᴄᴏɴꜰɪɢᴜʀᴇ ʏᴏᴜʀ ꜱʜᴏʀᴛɴᴇʀ ꜱᴇᴛᴛɪɴɢꜱ!**</blockquote>"""
    ...
    image_url = MESSAGES.get("SHORT", "https://telegra.ph/file/4466d37d43f5703516f74.jpg")
